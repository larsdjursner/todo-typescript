...
const initialValues = [
	...
	{ id: 2, content: "take out the trash", completed: true, date: new Date('1994-02-18') },
	{ id: 3, content: "wash the dishes", completed: false, date: new Date('2021-02-28') },
	{ id: 4, content: "endure specific lectures", completed: true, date: new Date('2011-03-21') },
	{ id: 5, content: "sleep", completed: false, date: new Date('2012-03-21') },
	{ id: 6, content: "eat", completed: true, date: new Date('2015-12-28')},
	{ id: 7, content: "sleep & eat", completed: false, date: new Date('2021-01-21')},
]
